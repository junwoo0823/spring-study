...
public class BoardRestController {
	...
	public BoardVO write(List<MultipartFile> files, BoardVO boardVO, HttpServletRequest request,
	...
	@GetMapping(value = "/boards/pages/{pageNum}", produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
