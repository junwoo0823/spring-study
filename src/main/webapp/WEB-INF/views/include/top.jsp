...
<nav class="nav-extended light-blue lighten-1">
	<div class="container right-align" style="font-size: 13px; height: 40px;">
		...
		<c:choose>
			...
			<c:otherwise>
				...
				<img src="/display?fileName=${ fileCallPath }" id="input-image" style="width: 40px; border-radius: 80px; background-color: white;">
			</c:otherwise>
		</c:choose>
	...
	<div class="nav-wrapper container">
		<a id="logo-container" href="/index" class="brand-logo"> <i class="material-icons">android</i>Logo
		</a>
		...
		<ul class="right hide-on-med-and-down">
			...
			<c:if test="${ not empty sessionScope.id }">
				<!-- 로그인 상태일때 -->
				<!-- Dropdown Trigger -->
				<li><a href="#!" class="dropdown-trigger" data-target="dropdownMember"> 내정보<i class="material-icons right">arrow_drop_down</i>
				</a></li>
			</c:if>

			<!-- 로그인 관계없이 보이는 메뉴 -->
			<li><a href="#!" class="dropdown-trigger" data-target="dropdownBoard"> 게시판<i class="material-icons right">arrow_drop_down</i>
			</a></li>
			<li><a href="#!" class="dropdown-trigger" data-target="dropdownChat"> 채팅<i class="material-icons right">arrow_drop_down</i>
			</a></li>
		</ul>
	</div>
</nav>
...
<ul id="dropdownMember" class="dropdown-content">
	<li><a href="/member/passwd">비밀번호<br>변경
	</a></li>
	<li><a href="/member/modify">내정보<br>수정
	</a></li>
	<li class="divider"></li>
