							...
							<form action="/member/join" method="POST" id="frm" name="frm">
								<div class="row">
									<div class="input-field col s12 m8 l9">
										<i class="material-icons prefix">account_box</i> <input id="id" type="text" name="id" data-length="20"> <label for="id">아이디</label>
								...
								<div class="row">
									<div class="input-field col s12">
										<i class="material-icons prefix">lock</i> <input id="passwd" type="password" class="validate" name="passwd" data-length="10"> <label
											for="passwd">비밀번호</label> <span class="helper-text" data-error="비밀번호는 10글자까지만 가능합니다." data-success="OK!">Helper text</span>
									</div>

									<div class="input-field col s12">
										<i class="material-icons prefix">check</i> <input id="passwd2" type="password" data-length="10"> <label for="passwd2">비밀번호
											재확인</label> <span class="helper-text"></span>
									</div>
								</div>

								<div class="row">
									<div class="input-field col s12">
										<i class="material-icons prefix">person</i> <input id="name" type="text" class="validate" name="name"> <label for="name">이름</label>
									</div>
								</div>

								<div class="row">
									<div class="input-field">
										<i class="material-icons prefix">event</i> <input type="date" id="birthday" name="birthday"> <label for="birthday">생년월일</label>
									</div>
								</div>
								...
								<div class="row">
									<div class="input-field col s12">
										<i class="material-icons prefix">mail</i> <input id="email" type="email" class="validate" name="email"> <label for="email">본인
											확인 이메일</label>
									</div>
								</div>

								<p class="row center">
									알림 이메일 수신 : &nbsp;&nbsp; <label> <input name="recvEmail" value="Y" type="radio" checked /> <span>예</span>
									</label> &nbsp;&nbsp; <label> <input name="recvEmail" value="N" type="radio" /> <span>아니오</span>
									</label>
								</p>
