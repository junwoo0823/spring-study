					...
					<div class="row">
						<div class="col s12" style="padding: 0 2%;">
							...
							<c:if test="${ not empty sessionScope.id }">
								<div class="row">
									<a href="/board/write?pageNum=${ pageMaker.cri.pageNum }" class="btn waves-effect waves-light right"> <i class="material-icons left">create</i>새글쓰기
									</a>
								</div>
							</c:if>
								...
								<div class="row">
									<div class="col s12 l4">
										<div class="input-field">
											<i class="material-icons prefix">find_in_page</i> <select name="type">
									...
									<div class="col s12 l4">
										<!-- AutoComplete -->
										<div class="input-field">
											<i class="material-icons prefix">search</i> <input type="text" id="autocomplete-input" class="autocomplete" name="keyword"
												value="${ pageMaker.cri.keyword }"> <label for="autocomplete-input">검색어</label>
										</div>
										<!-- end of AutoComplete -->
									</div>
