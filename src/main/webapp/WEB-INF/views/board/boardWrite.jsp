						...
						<div class="col s12" style="padding: 0 5%;">
							...
							<form action="/board/write" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="input-field col s12">
										<i class="material-icons prefix">account_box</i> <input id="id" type="text" name="mid" value="${ sessionScope.id }" readonly> <label
											for="id">아이디</label> <span class="helper-text" data-error="wrong" data-success="right">필수 정보입니다.</span>
									</div>
								</div>
								...
								<div class="row center">
									...
									&nbsp;&nbsp;
									<button class="btn waves-effect waves-light" type="button" onclick="location.href = '/board/list?pageNum=${ pageNum }'">
