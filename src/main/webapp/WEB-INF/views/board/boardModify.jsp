							...
							<form action="/board/modify" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="input-field">
										<i class="material-icons prefix">subtitles</i> <input type="text" id="title" class="validate" name="subject" value="${ board.subject }">
								...
								<div class="row center">
									<button class="btn waves-effect waves-light" type="submit">
										글수정 <i class="material-icons right">create</i>
									</button>
									&nbsp;&nbsp;
