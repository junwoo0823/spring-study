					...
					<div class="row">
						<div class="col s12" style="padding: 0 5%;">
							...
							<form action="/board/reply" method="POST" enctype="multipart/form-data">
								<input type="hidden" name="pageNum" value="${ pageNum }"> <input type="hidden" name="reRef" value="${ reRef }"> <input
									type="hidden" name="reLev" value="${ reLev }"> <input type="hidden" name="reSeq" value="${ reSeq }">

								<div class="row">
									<div class="input-field col s12">
										<i class="material-icons prefix">account_box</i> <input id="id" type="text" name="mid" value="${ sessionScope.id }" readonly> <label
											for="id">아이디</label>
									</div>
								</div>
								...
								<div class="row">
									<div class="input-field">
										<i class="material-icons prefix">subtitles</i> <input type="text" id="title" class="validate" name="subject"> <label for="title">제목</label>
									</div>
								</div>
								<div class="row">
									<div class="input-field">
								...
								<div class="row center">
									...
									&nbsp;&nbsp;
									<button class="btn waves-effect waves-light" type="button" onclick="location.href = '/board/boardList.jsp'">
